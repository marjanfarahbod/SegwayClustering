...
segtools_dir = Path('/home/marjan_farahbod/segwayOutput') # contains a directory for each cell type, where segtool outputs are
...
###### >>>> input files old version

# # Trained sklearn model for classification
# model_fname = "model.pickle.gz"
# model = pickle.load(gzip.open(model_fname))

# # Annotations to classify /oldversion
# format: id \t path
...
#### original version, gets the list of target annotations in a file >>> 
# target_anns = []
# next_id = 0
