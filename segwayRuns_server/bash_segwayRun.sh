...
segway train --include-coords=data/encodePilotRegions.hg19.bed --num-labels=15 --resolution=100 --minibatch-fraction=0.01 --num-instances=10 --prior-strength=1.0 --segtransition-weight-scale=1.0 --ruler-scale=100 --track-weight=0.002 --max-train-rounds=25 data/DND-41.genomedata DND41train
