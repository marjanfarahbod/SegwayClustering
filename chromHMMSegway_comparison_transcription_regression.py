########################################
# 5. That regressiong thing
########################################

# TODO add the proper header, intro and initiation section for this code
...
for accession in accessionList:
    if accession in list(aucs.keys()):
        ...
        if expMod == 1: # 10% low expressed filtered
        ...
        # >>>>> 2.3 Switch 3
        if expMod == 2: # 15% low expressed filtered
        ...
        # >>>>> 2.4 Switch 4
        if expMod == 3: # 10% low expressed considered zero expressed
        ...
        # >>>>> 2.5 Switch 5
        if expMod == 4: # 15% low expressed considered zero expressed
        ...
        if balanced == True: # if we want balanced regression
        ...
        accuracy_score(y_test, y_pred) # a float
